...
public class Transform {
	...
	public void insereDb() {
		...
		db.insereProducao(new Producao("" + numeroOrdemInt, pecaOrigem, pecaFinal, Integer.valueOf(quantidadeProduzir),
				Integer.valueOf(atrasoMaximo)));
		Ordens ordem = new Ordens("" + numeroOrdemInt, Integer.valueOf(atrasoMaximo), Ordem.localDate(),
				Integer.valueOf(atrasoMaximo), fabrica);
